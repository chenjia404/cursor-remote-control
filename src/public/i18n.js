...
const messages = {
  zh: {
    ...
    "settings.voice": "语音模式",
    "settings.voiceHint": "开启后会朗读思考、工具和回复。任务进行中再说一句会打断当前轮。",
  ...
  en: {
    ...
    "settings.voiceHint": "When on, the app reads thinking, tool actions, and replies. Speaking again while a turn is running interrupts it.",
