...
const messages = {
  zh: {
    ...
    "api.scheduleFrequency": "请选择每天、每周或按小时间隔",
    ...
    "schedule.new": "新建规则",
    "schedule.edit": "编辑规则",
    "schedule.hint": "到点后会按规则把指令交给 Cursor Agent，不会提供任意 Shell。",
  ...
  en: {
    ...
    "api.scheduleFrequency": "Choose daily, weekly, or an hourly interval",
    ...
    "schedule.hint": "When due, the prompt is sent to the Cursor Agent. No arbitrary shell.",
