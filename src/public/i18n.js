...
const messages = {
  zh: {
    ...
    "session.followUpHintBusy": "本轮进行中，发送后将排队，当前轮次结束后自动执行",
    "session.followUpHintNoAgent": "该任务没有可继续的会话",
    "session.followUpHintReady": "在同一任务中继续对话 · Enter 发送，Shift+Enter 换行",
    ...
    "model.param.thinking": "思考",
    "model.param.thinking_level": "思考强度",
    "model.param.low": "低",
  ...
  en: {
    ...
    "session.followUpHintBusy": "This round is running. Your message will be queued and sent after it finishes.",
    "session.followUpHintNoAgent": "This task has no resumable session",
    "session.followUpHintReady": "Continue this task · Enter to send, Shift+Enter for a new line",
    ...
    "model.param.thinking": "Thinking",
    "model.param.thinking_level": "Thinking effort",
    "model.param.low": "Low",
