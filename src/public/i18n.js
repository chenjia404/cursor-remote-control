...
const messages = {
  zh: {
    ...
    "settings.voice": "语音模式",
    "settings.voiceHint": "开启后会朗读思考、工具和回复。进入会话不会把旧内容从头读一遍。任务进行中再说一句会打断当前轮。",
    "settings.voiceAutoSend": "说完自动发送",
    "settings.voiceSpeakThinking": "朗读思考过程",
    "settings.voiceSpeakTools": "朗读工具动作",
    "settings.voiceSpeakReply": "朗读最终回复",
    ...
    "tool.askQuestion": "提问",
    "tool.await": "等待",
    "tool.applyAgentDiff": "应用改动",

    "voice.mic": "语音输入",
    "voice.stop": "停止录音",
    "voice.recording": "正在录音…",
    "voice.recordingTime": "正在录音… {seconds}s",
    "voice.transcribing": "正在转写…",
    "voice.speaking": "正在朗读…",
    "voice.micDenied": "未获得麦克风权限",
    "voice.unsupported": "当前浏览器不支持语音输入",
    "voice.noTranscribe": "未配置语音转写，且浏览器不支持语音识别",
    "voice.empty": "没有识别到内容",
    "voice.tooShort": "录音太短",
    "voice.skipCode": "回复以代码为主，已跳过朗读",
    "voice.toolStart": "正在{name}",
    "voice.toolDone": "{name}完成",
    "voice.toolFailed": "{name}失败",
    "voice.recordFailed": "录音失败",

    "api.transcribeDisabled": "未配置语音转写",
    "api.audioTooLarge": "录音不能超过 2MB",
    "api.audioUnsupported": "不支持的音频格式",
    "api.audioInvalid": "录音内容无效",
    "api.transcribeFailed": "语音转写失败",
    ...
    "api.pathInvalid": "项目路径无效",
    "api.workspaceInvalid": "任务工作目录无效",
    ...
    "api.scheduleNotFound": "定时规则不存在",
    "api.scheduleNameRequired": "规则名称不能为空",
    "api.scheduleNameTooLong": "规则名称不能超过 80 字",
    "api.schedulePromptRequired": "请输入定时任务指令",
    "api.schedulePromptTooLong": "定时任务指令过长",
    "api.scheduleCronFormat": "Cron 表达式需为 5 段，例如 0 3 * * 1",
    "api.scheduleCronInvalid": "无效的 Cron 表达式",
    "api.scheduleNextFailed": "无法计算下次执行时间",
    "api.scheduleWeekdays": "请选择每周的执行日",
    "api.scheduleTime": "请填写有效的执行时刻，格式为 HH:MM",
    "api.scheduleFrequency": "请选择每天、每周、每月或按小时间隔",
    "api.scheduleMonthDay": "请填写每月的执行日，范围为 1 到 31",
    "api.scheduleInterval": "间隔小时数需为 1 到 168",
    "api.scheduleBusy": "规则正在触发",
    "api.scheduleOverlap": "上一轮任务仍在进行，已跳过本轮",
    "api.scheduleOwnerDisabled": "规则属主已停用",
    "api.scheduleOwnerMissing": "规则属主不存在",
    "api.scheduleProjectGone": "项目已不再是已确认项目",
    "api.scheduleOwnerProject": "属主没有该项目的使用权限",
    "api.scheduleOwnerExtra": "属主没有附加工作区的使用权限",
    "api.scheduleTriggerFailed": "触发失败",
    "api.scheduleOwnerCreate": "规则属主没有新建任务的权限",

    "schedule.new": "新建规则",
    "schedule.edit": "编辑规则",
    "schedule.hint": "到点后会按规则把指令交给 Cursor Agent，不会提供任意 Shell。停用的规则仍会留在列表里，不需要了可以直接删除。",
    "schedule.empty": "还没有定时规则",
    "schedule.name": "名称",
    "schedule.namePlaceholder": "例如：每周更新依赖",
    "schedule.kind": "调度方式",
    "schedule.kindSimple": "简单周期",
    "schedule.kindCron": "Cron",
    "schedule.frequency": "周期",
    "schedule.daily": "每天",
    "schedule.weekly": "每周",
    "schedule.monthly": "每月",
    "schedule.monthlySummary": "每月 {day} 日 {time}",
    "schedule.interval": "每 N 小时",
    "schedule.time": "时刻",
    "schedule.weekdays": "星期",
    "schedule.monthDay": "每月几号",
    "schedule.monthDayHint": "没有该日的月份会跳过，例如 31 号不会在 2 月执行。",
    ...
    "schedule.intervalHours": "间隔小时",
    "schedule.cron": "Cron 表达式",
    "schedule.cronPlaceholder": "0 3 * * 1",
    "schedule.cronHint": "5 段：分 时 日 月 周，例如 0 3 * * 1 表示每周一 03:00。",
    "schedule.next": "下次 {time}",
    "schedule.last": "上次 {time}",
    "schedule.never": "尚未执行",
    "schedule.promptPlaceholder": "例如：检查并更新依赖，跑完现有测试后用中文说明结果。",
    "schedule.templateDeps": "更新依赖",
    "schedule.templateDepsPrompt": "检查并更新本项目的依赖到合理的最新兼容版本。先看清包管理器与锁文件，避免破坏性大版本升级；更新后运行现有检查或测试，修复因此产生的问题，最后用简要中文说明改了什么。",
    "schedule.templateErrors": "处理异常",
    "schedule.templateErrorsPrompt": "检查本项目最近的异常、失败测试或明显的错误处理缺口。优先修复会在运行时出错的问题，不要做无关重构。完成后用简要中文说明发现与处理结果。",
    "schedule.resumeLast": "继续上次会话",
    "schedule.enabled": "启用此规则",
    "schedule.save": "保存规则",
    "schedule.saved": "定时规则已保存",
    "schedule.delete": "删除",
    "schedule.deleted": "定时规则已删除",
    "schedule.deleteConfirm": "确定删除这条定时规则？",
    "schedule.run": "立即执行",
    "schedule.disabled": "已停用",
    "schedule.owner": "由 {name} 创建",
    "history.scheduled": "定时",
  },
  en: {
    ...
    "settings.voice": "Voice mode",
    "settings.voiceHint": "When on, the app reads thinking, tool actions, and replies. Opening a session does not read old messages from the start. Speaking again while a turn is running interrupts it.",
    "settings.voiceAutoSend": "Send after speaking",
    "settings.voiceSpeakThinking": "Read thinking",
    "settings.voiceSpeakTools": "Read tool actions",
    "settings.voiceSpeakReply": "Read the final reply",
    ...
    "tool.ls": "List folder",
    "tool.semSearch": "Semantic search",
    "tool.readLints": "Read lints",
    "tool.updateTodos": "Update todos",
    "tool.readTodos": "Read todos",
    "tool.askQuestion": "Ask question",
    "tool.await": "Wait",
    "tool.applyAgentDiff": "Apply changes",

    "voice.mic": "Voice input",
    "voice.stop": "Stop recording",
    "voice.recording": "Recording…",
    "voice.recordingTime": "Recording… {seconds}s",
    "voice.transcribing": "Transcribing…",
    "voice.speaking": "Speaking…",
    "voice.micDenied": "Microphone permission denied",
    "voice.unsupported": "This browser cannot capture voice input",
    "voice.noTranscribe": "Server transcription is not configured, and this browser has no speech recognition",
    "voice.empty": "Nothing was recognized",
    "voice.tooShort": "Recording is too short",
    "voice.skipCode": "The reply is mostly code, so it was not read aloud",
    "voice.toolStart": "{name}",
    "voice.toolDone": "{name} done",
    "voice.toolFailed": "{name} failed",
    "voice.recordFailed": "Recording failed",

    "api.transcribeDisabled": "Voice transcription is not configured",
    "api.audioTooLarge": "Recording must be 2MB or smaller",
    "api.audioUnsupported": "Unsupported audio format",
    "api.audioInvalid": "Invalid recording",
    "api.transcribeFailed": "Voice transcription failed",
    ...
    "toast.copyFailed": "Copy failed. Long-press to select the text.",
    ...
    "api.pathInvalid": "Project path is invalid",
    "api.workspaceInvalid": "Task working directory is invalid",
    ...
    "api.scheduleNotFound": "Schedule not found",
    "api.scheduleNameRequired": "Name is required",
    "api.scheduleNameTooLong": "Name cannot exceed 80 characters",
    "api.schedulePromptRequired": "Enter a scheduled prompt",
    "api.schedulePromptTooLong": "Scheduled prompt is too long",
    "api.scheduleCronFormat": "Cron must have 5 fields, e.g. 0 3 * * 1",
    "api.scheduleCronInvalid": "Invalid cron expression",
    "api.scheduleNextFailed": "Could not compute the next run time",
    "api.scheduleWeekdays": "Select at least one weekday",
    "api.scheduleTime": "Enter a valid time as HH:MM",
    "api.scheduleFrequency": "Choose daily, weekly, monthly, or an hourly interval",
    "api.scheduleMonthDay": "Day of month must be 1 to 31",
    "api.scheduleInterval": "Interval must be 1 to 168 hours",
    "api.scheduleBusy": "This rule is already firing",
    "api.scheduleOverlap": "The previous run is still active; this occurrence was skipped",
    "api.scheduleOwnerDisabled": "The rule owner is disabled",
    "api.scheduleOwnerMissing": "The rule owner no longer exists",
    "api.scheduleProjectGone": "This project is no longer confirmed",
    "api.scheduleOwnerProject": "The owner cannot use this project",
    "api.scheduleOwnerExtra": "The owner cannot use an attached workspace",
    "api.scheduleTriggerFailed": "Failed to trigger the rule",
    "api.scheduleOwnerCreate": "The rule owner cannot create tasks",

    "schedule.new": "New rule",
    "schedule.edit": "Edit rule",
    "schedule.hint": "When due, the prompt is sent to the Cursor Agent. No arbitrary shell. Disabled rules stay in the list until you delete them.",
    "schedule.empty": "No scheduled rules yet",
    "schedule.name": "Name",
    "schedule.namePlaceholder": "e.g. Weekly dependency update",
    "schedule.kind": "Schedule type",
    "schedule.kindSimple": "Simple",
    "schedule.kindCron": "Cron",
    "schedule.frequency": "Frequency",
    "schedule.daily": "Daily",
    "schedule.weekly": "Weekly",
    "schedule.monthly": "Monthly",
    "schedule.monthlySummary": "Monthly on day {day} at {time}",
    "schedule.interval": "Every N hours",
    "schedule.time": "Time",
    "schedule.weekdays": "Weekdays",
    "schedule.monthDay": "Day of month",
    "schedule.monthDayHint": "Months without that day are skipped, for example the 31st in February.",
    ...
    "schedule.intervalHours": "Interval (hours)",
    "schedule.cron": "Cron expression",
    "schedule.cronPlaceholder": "0 3 * * 1",
    "schedule.cronHint": "5 fields: min hour day month weekday. Example: 0 3 * * 1 is Monday 03:00.",
    "schedule.next": "Next {time}",
    "schedule.last": "Last {time}",
    "schedule.never": "Not run yet",
    "schedule.promptPlaceholder": "e.g. Review and update dependencies, run existing tests, then summarize in Chinese.",
    "schedule.templateDeps": "Update deps",
    "schedule.templateDepsPrompt": "Review and update this project's dependencies to the latest reasonable compatible versions. Identify the package manager and lockfile first; avoid breaking major upgrades. After updating, run existing checks or tests, fix fallout, and summarize what changed in brief Chinese.",
    "schedule.templateErrors": "Handle errors",
    "schedule.templateErrorsPrompt": "Inspect recent exceptions, failing tests, or obvious error-handling gaps in this project. Prefer fixes that prevent runtime failures; skip unrelated refactors. Summarize findings and actions in brief Chinese.",
    "schedule.resumeLast": "Continue last session",
    "schedule.enabled": "Enable this rule",
    "schedule.save": "Save rule",
    "schedule.saved": "Schedule saved",
    "schedule.delete": "Delete",
    "schedule.deleted": "Schedule deleted",
    "schedule.deleteConfirm": "Delete this scheduled rule?",
    "schedule.run": "Run now",
    "schedule.disabled": "Disabled",
    "schedule.owner": "Created by {name}",
...
const apiErrorKeys = {
  ...
  项目路径无效: "api.pathInvalid",
  任务工作目录无效: "api.workspaceInvalid",
  ...
  定时规则不存在: "api.scheduleNotFound",
  规则名称不能为空: "api.scheduleNameRequired",
  "规则名称不能超过 80 字": "api.scheduleNameTooLong",
  ...
  "请选择每天、每周或按小时间隔": "api.scheduleFrequency",
  "请选择每天、每周、每月或按小时间隔": "api.scheduleFrequency",
  "请填写每月的执行日，范围为 1 到 31": "api.scheduleMonthDay",
  "间隔小时数需为 1 到 168": "api.scheduleInterval",
  规则正在触发: "api.scheduleBusy",
  "上一轮任务仍在进行，已跳过本轮": "api.scheduleOverlap",
  规则属主已停用: "api.scheduleOwnerDisabled",
  规则属主不存在: "api.scheduleOwnerMissing",
  项目已不再是已确认项目: "api.scheduleProjectGone",
  属主没有该项目的使用权限: "api.scheduleOwnerProject",
  属主没有附加工作区的使用权限: "api.scheduleOwnerExtra",
  触发失败: "api.scheduleTriggerFailed",
  规则属主没有新建任务的权限: "api.scheduleOwnerCreate",
  ...
  未配置语音转写: "api.transcribeDisabled",
  "录音不能超过 2MB": "api.audioTooLarge",
  "录音内容过大或无效": "api.audioTooLarge",
  不支持的音频格式: "api.audioUnsupported",
  录音内容无效: "api.audioInvalid",
  语音转写失败: "api.transcribeFailed",
};
