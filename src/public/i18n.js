...
const messages = {
  zh: {
    ...
    "session.followUpHintBusy": "本轮进行中：默认排队，点「追加」会中断当前轮并立刻执行",
    ...
    "session.followUpQueue": "排队",
    "session.followUpAppend": "追加",
  ...
  en: {
    ...
    "session.followUpHintBusy": "This round is running. Queue by default, or tap Append to interrupt and send now.",
    ...
    "session.followUpQueue": "Queue",
    "session.followUpAppend": "Append",
